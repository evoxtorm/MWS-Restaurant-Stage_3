...
const cssFiles = ['https://unpkg.com/leaflet@1.3.1/dist/leaflet.css', 'dist/css/styles.min.css'];

const jsFiles = ['https://unpkg.com/leaflet@1.3.1/dist/leaflet.js', 'dist/js/index.min.js', 'dist/js/restaurant.min.js'];

self.addEventListener('install', (event) => {
  self.skipWaiting();
  event.waitUntil(caches.open(staticCacheName).then((cache) => {
    cache.addAll([
      '/', 'manifest.json', ...cssFiles,
      ...jsFiles
    ]);
  }).catch(() => {
